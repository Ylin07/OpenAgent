...
import { EventSequenceTable, EventTable } from "@openagent-ai/core/event/sql"
...
import { Slug } from "@openagent-ai/core/util/slug"
...
export class Service extends Context.Service<Service, Interface>()("@openagent/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OPENAGENT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OPENAGENT_WORKSPACE_ID: config.id,
        OPENAGENT_EXPERIMENTAL_WORKSPACES: "true",
