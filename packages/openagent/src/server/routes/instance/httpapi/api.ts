...
export const RootHttpApi = HttpApi.make("openagent-root")
...
export const InstanceHttpApi = HttpApi.make("openagent-instance")
...
export const OpenAgentHttpApi = HttpApi.make("openagent")
