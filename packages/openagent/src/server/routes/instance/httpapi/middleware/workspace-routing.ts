...
>()("@openagent/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@openagent/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.OPENAGENT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.OPENAGENT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-openagent-directory"] || process.cwd()
}
