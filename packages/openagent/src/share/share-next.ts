import type * as SDK from "@openagent-ai/sdk/v2"
...
import { SessionShareTable } from "@openagent-ai/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@openagent/ShareNext") {}
