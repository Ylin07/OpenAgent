...
import type { LLMEvent } from "@openagent-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@openagent-ai/llm/route"
import type { LLMClientService } from "@openagent-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@openagent/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @openagent-ai/llm. It
