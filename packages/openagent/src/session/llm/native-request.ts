import type { JsonSchema, LLMRequest, ProviderMetadata } from "@openagent-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@openagent-ai/llm"
import { OpenAICompatible } from "@openagent-ai/llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @openagent-ai/llm request objects from openagent's session/AI SDK-shaped data.
  return LLM.request({
