...
import { buildPrompt } from "@openagent-ai/core/session/compaction"
...
export class Service extends Context.Service<Service, Interface>()("@openagent/SessionCompaction") {}
