...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@openagent/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@openagent/ACPDirectory") {}
