...
import type { AssistantMessage as OpenAgentAssistantMessage, Message } from "@openagent-ai/sdk/v2"
...
export type AssistantTokenCost = Pick<OpenAgentAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<OpenAgentAssistantMessage, "role"> &
  Partial<Pick<OpenAgentAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@openagent/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@openagent/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@openagent/ACPUsage") {}
