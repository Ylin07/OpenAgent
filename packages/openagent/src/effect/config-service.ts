 ...
 *   "@openagent/ServerAuthConfig",
 *   {
 *     password: Config.string("OPENAGENT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("OPENAGENT_SERVER_USERNAME").pipe(Config.withDefault("openagent")),
 *   },
 * ) {}
 *
