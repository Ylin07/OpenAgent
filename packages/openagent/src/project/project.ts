...
import { ProjectDirectoryTable, ProjectTable } from "@openagent-ai/core/project/sql"
import { SessionTable } from "@openagent-ai/core/session/sql"
import { WorkspaceTable } from "@openagent-ai/core/control-plane/workspace.sql"
import * as Log from "@openagent-ai/core/util/log"
import { Flag } from "@openagent-ai/core/flag/flag"
import { GlobalBus } from "@/bus/global"
import { which } from "@openagent-ai/core/util/which"
...
import { ProjectCopy } from "@openagent-ai/core/project/copy"
import { CrossSpawnSpawner } from "@openagent-ai/core/cross-spawn-spawner"
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@openagent-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@openagent/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.OPENAGENT_FAKE_VCS)
