...
import { AccountStateTable, AccountTable } from "@openagent-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@openagent/AccountRepo") {}
