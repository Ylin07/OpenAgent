...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@openagent-ai/sdk/v2"
  ...
  return [
    ...pipe(
      ...
      map((provider) => ({
        ...
        description: {
          openagent: "(Recommended)",
          "openagent-go": "Low cost subscription for everyone",
        }[provider.id],
      ...
      description={
        {
          openagent: (
            <box gap={1}>
              <text fg={theme.textMuted}>
                OpenAgent Zen gives you access to all the best coding models at the cheapest prices with a single API
                key.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://openagent.ai/zen</span> to get a key
              </text>
            </box>
          ),
          "openagent-go": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                OpenAgent Go is a $10 per month subscription that provides reliable access to popular open coding models
