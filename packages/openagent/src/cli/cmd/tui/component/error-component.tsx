...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/anomalyco/openagent/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("openagent-version", InstallationVersion)
