...
import { type Model } from "@openagent-ai/llm"
import * as OpenAICompatibleChat from "@openagent-ai/llm/protocols/openai-compatible-chat"
import { Auth, type AnyRoute } from "@openagent-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@openagent/v2/SessionRunnerModel") {}
