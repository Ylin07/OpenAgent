export * as OpenAgent from "./openagent"
...
/** Intentional public native API for Effect applications embedding OpenAgent. */
export class Service extends Context.Service<Service, Interface>()("@openagent/public/OpenAgent") {}
...
>()("@openagent/public/OpenAgent/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("OpenAgent.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("OpenAgent.sessions.switchModel")(function* (input) {
...
// TODO: Add OpenAgent.create(...) as the Promise facade over the same native API semantics.
