...
declare const OPENAGENT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OPENAGENT_LIBC === "undefined" ? undefined : OPENAGENT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@openagent/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OPENAGENT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.OPENAGENT_EXPERIMENTAL_FILEWATCHER) {
