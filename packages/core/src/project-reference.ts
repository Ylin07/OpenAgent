...
export class Service extends Context.Service<Service, Interface>()("@openagent/ProjectReference") {}
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (!Flag.OPENAGENT_EXPERIMENTAL_REFERENCES) return Service.of(inert)
